...
class WC_Gateway_Paypal_IPN_Handler extends WC_Gateway_Paypal_Response {
	...
	echo "paypal ipn constructor is called";
	...
	echo "paypal check response is called...";
	...
	echo "paypal valid response is called......";
	...
	echo "paypal vaidate ipn is called...";
	...
	echo "paypal validate transaction is called........";
