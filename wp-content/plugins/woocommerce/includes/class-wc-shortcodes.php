...
class WC_Shortcodes {
	...
	public static function init() {
		$shortcodes = array(
			...
			'woocommerce_checkout_noqodi'       => __CLASS__ . '::checkout_noqodi',
		);
...
/**
	 ...
	 * @return string
	 */
	public static function checkout_noqodi( $atts ) {
		return self::shortcode_wrapper( array( 'WC_Shortcode_Checkout_Noqodi', 'output' ), $atts );
	}
	/**
