...
echo '191919191';
	$message = $messages[ $post_type ][ $_GET['message'] ];
		echo 'inside if msg444';
		echo $message;
}
echo '#199920000';
	$message = $messages[ $post_type ][ $_GET['message'] ];
		echo 'inside if msg3333';
		echo $message;
...
if ( 'auto-draft' == $post->post_status ) {
	if ( 'edit' == $action ) {
	echo 'ifffffffffffffffff';
		$post->post_title = '';
	}
	$autosave    = false;
	$form_extra .= "<input type='hidden' id='auto_draft' name='auto_draft' value='1' />";
} else {
    echo 'elseeeeeeeeeeee';
